...
if ( ! class_exists( 'Barcelona_Widget_Posts' ) ) {
						...
						<div class="col col-md-12 col-sm-6 col-xs-12">
							<div class="post-summary post-format-<?php echo sanitize_html_class( barcelona_get_post_format() ); ?> psum-horizontal psum-small clearfix">
								<div class="post-image">
									<a href="<?php echo esc_url( get_the_permalink() ); ?>" title="<?php echo esc_attr( get_the_title() ); ?>" class="test">
										<?php
										barcelona_psum_overlay();
										barcelona_thumbnail( 'barcelona-sm' ); //RW
										?>
									</a>
								</div>
