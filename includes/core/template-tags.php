...
if ( ! function_exists( 'barcelona_author_box' ) ) {
	...
	<div class="<?php echo implode( ' ', $barcelona_cls ); ?>">
		...
		<div itemprop="author" itemscope itemtype="http://schema.org/Person" class="author-details author vcard">

			<span itemprop="name" class="author-name fn">
...
if ( ! function_exists( 'barcelona_featured_img' ) ) {
	function barcelona_featured_img( $barcelona_fimg_id=NULL ) {
		...
		$barcelona_is_media = in_array( $barcelona_post_format, array( 'audio', 'video' ) );//RW
		...
		if ( in_array( $barcelona_post_format, array( 'video' ) ) && $barcelona_fimg_id != 'cl' ) { //RW
		...
		// Post title
		$barcelona_post_title = '<h1 itemprop="name" class="entry-title post-title">'. esc_html( $post->post_title ) .'</h1>';
				...
				<div class="featured-image">
					...
					<div class="barcelona-parallax-wrapper">
						<div class="barcelona-parallax-inner">
							<img itemprop="image" src="<?php echo esc_url( $barcelona_featured_image_url[0] ); ?>" alt="<?php echo esc_attr( $post->post_title ); ?>" />
						</div>
					</div>
					<?php endif; ?>
